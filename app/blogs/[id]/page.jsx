            ...
            <>
                <div className='bg-gray-200 py-5 px-5 md:px-12 lg:px-28'>
                    <div className='flex justify-between items-center'>
                        <Link href='/'>
                            <Image src={assets.logo} width={180} className='w-[130px] sm:w-auto' alt='Blog logo' />
                        </Link>
                        <button className='flex items-center gap-2 font-medium py-1 px-3 sm:py-3 lg:px-6 border border-black shadow-[-7px_2px_0px_#000000]'>
                            Get Started
                            <Image src={assets.arrow} alt='Get started arrow' />
                        </button>
                    </div>
                ...
                <div className='max-w-[800px] md:mx-auto mt-[-10px] mb-10'>
                    <Image className='border-4 border-white' src={data.image} width={1280} height={720} alt='Blog main image' />
